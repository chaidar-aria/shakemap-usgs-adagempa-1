...
# local imports
from esi_shakelib.rupture.origin import read_event_file
...
def get_parser():
    ...
    parser.add_argument(
        "-pv",
        "--product-version",
        help="Set the version of the ShakeMap product rather than examining "
        "file structure or history.json",
    )
